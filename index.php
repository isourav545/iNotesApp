...
//die if the connection is not succesful
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  if (isset( $_POST['snoEdit'])){
    ...
    if ($result) {
      // echo "The records has been successfully inserted <br>" ;
      $insert = true;
    } else {
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="#"><img src="/crud/logo.svg"  alt="Inotes" style=" height:28px;"></a>
